    ...
    def __init__(self,
        ...
        if num_layers == 1:
            self.gat_layers.append(
                GATConv(
                    hidden_in, hidden_out, nhead_out, feat_drop, attn_drop, negative_slope, last_residual,
            ...
            self.gat_layers.append(
                GATConv(
                    hidden_in, num_hidden, nhead, feat_drop, attn_drop, negative_slope, residual,
            ...
            for _ in range(1, num_layers - 1):
                ...
                self.gat_layers.append(
                    GATConv(
                        num_hidden * nhead, num_hidden, nhead, feat_drop, attn_drop, negative_slope, residual,
                        create_activation(activation), norm=norm, concat_out=concat_out
                    )
                )
            ...
            self.gat_layers.append(
                GATConv(
                    num_hidden * nhead, hidden_out, nhead_out, feat_drop, attn_drop, negative_slope, last_residual,
